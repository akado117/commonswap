                    ...
                    <div className="row">
                        <div className="col s6">
                            ...
                            <div className="row center-align">
                                ...
                                <p className="col s9 offset-s1 how-desc">Join our community by signing up and listing
                    ...
                    <div className="row">
                        <div className="offset-s6 col s6">
                            <div className="row center-align">
                                ...
                                <p className="col s9 offset-s1 how-desc">Enter your travel dates and desired location.
                    ...
                    <div className="row">
                        <div className="col s6">
                            <div className="row center-align">
                                ...
                                <p className="col s9 offset-s1 how-desc">You're all set! Enjoy your getaway and
