    ...
    return (
        <div className="col s12 z-depth-2 browse-place-container" style={{ marginBottom: '20px' }}>
            <div className="col s12">
                <div className="row">
                    <div className="col s7 profile-image-container">
                    ...
                    <div className="col s5">
                        <div className="col s12">
                            <strong><p className="marg-top"><strong>{placeForBrowse.profile.firstName}</strong> ({placeForBrowse.address.city}, {placeForBrowse.address.state})</p></strong>
                        </div>
                        <div className="col s12">
