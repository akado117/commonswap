            ...
            <div className="place-container">
                ...
                <div className="row">
                    <div className="col s12 input-field inline">
                        <input type="text" className="" id="" onChange={e => getValFunc('shortDesc', onChangeHelper(e)) } defaultValue={place.shortDesc} />
                    ...
                    <div className="col s6 input-field inline">
                        ...
                        <input type="text" className="" id="" onChange={e => getValFunc('rent', onChangeHelper(e)) } defaultValue={place.rent} />
                    </div>
                    <div className="col s6 input-field inline">
                    ...
                    <div className="col s6 input-field inline">
                        <input type="number" className="" id="" onChange={e => getValFunc('numOfGuests', onChangeHelper(e)) } defaultValue={place.numOfGuests} />
                    ...
                    <div className="col s6 input-field">
                        ...
                        <input type="number" className="" id="" onChange={e => getValFunc('bedrooms', onChangeHelper(e)) } defaultValue={place.bedrooms} />
                    </div>
                    ...
                    <div className="col s12 input-field inline" style={{ paddingRight: '0px' }}>
                        ...
                        <input type="text" className="" id="" onChange={e => getValFunc('typeOfPets', onChangeHelper(e)) } defaultValue={place.typeOfPets} />
                    </div>
